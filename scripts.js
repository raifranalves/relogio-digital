...
//FUNÇÕES
/*A condição time < 10 verifica se o valor da variável time é menor que 10.
Se essa condição for verdadeira, o valor retornado será a concatenação da string '0' com o valor de time.
Caso contrário, ou seja, se a condição for falsa, o valor retornado será o próprio valor de time.*/
